...
router.post("/SignIn", async (req, res) => {
    ...
    if (!user) return res.status(404).send({status: "Invalid email! If you don't have an account, please sign up.",error:500 });
...
router.post("/SignUp", async (req, res) => {
    ...
    // Get request data.
    const { name, email, password, mobile, nic } = req.body;
